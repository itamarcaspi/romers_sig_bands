...
We start by transforming the data to long format
```{r}
...
Next, we estimate the stacked data as a panel using the `plm` package:
```{r}
...
Finally, we perform the joint hypothesis test:
```{r}
