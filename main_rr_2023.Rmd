...
The figure illustrates the impulse response of 100 times the logarithm of the GDP Price Index following a Romer and Romer (2023) monetary policy shock. The model includes four lagged variables for the GDP Price Index, and for the monetary policy shock. Dark and light green shaded areas indicate bands corresponding to one and two standard errors, respectively. For further details, refer to [Inoue, Jordà, and Kuersteiner (2023.)](https://arxiv.org/abs/2306.03073)
...
The following figure mirrors the previous one; however, we now include classical Newey-West significance bands (shown in dashed blue) and bootstrapped significance bands (shown in dashed red).
